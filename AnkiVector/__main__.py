...
PM_START_TEXT = """
HI I am [𝗦𝗛𝗘𝗟𝗔](https://t.me/Theshelabot)✨ I am a group management bot. You can manage your group for free from me and many more created by [cgs officials.](https://t.me/cgs_officials)
...
TECHNO_IMG = "https://telegra.ph/file/bc60d88f7cfb9706d3d23.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="❔ Help ❔",
                                                                       ...
                                                                       url="https://t.me/cgs_officials")],
                                                                                   [InlineKeyboardButton(text="Add To Group",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Group",
                                                                       url="https://t.me/cgs_official")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("hi, I am now Online @Theshelabot")
