...
HELP_STRINGS = f"""
The gollowing functions will help to you to manage your group✨✨
""".format(
...
BUTTONS = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="Vc assistant 🎤", url="https://t.me/SheLaHelper"
        ),
    ],
    [
        InlineKeyboardButton(text="➕️ ADD ME TO YOUR GROUP ➕️", url="http://t.me/TheSheLabot?startgroup=true"),
    ],
]
...
Join SheLa [Update channel📢](https://t.me/CGSUpdates) to get information on all the latest updates.  """
...
def DewmiBot_about_callback(update, context):
    query = update.callback_query
    if query.data == "aboutmanu_s":
        query.message.edit_text(
            text=f" @TheSheLabot - A bot to manage your groups with additional features!"
            f"\n\n Here's the basic help regarding use of @TheSheLabot."
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Bᴜɢ'ꜱ🐞", url="t.me/cgsupdates"
                        ),
                        InlineKeyboardButton(
                            text="updates💁‍♀️", url="t.me/cgsupdates"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="Donate 🤕", url="http://t..me/TheSheLabot?start=donate"
                        ),
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            ...
            f"\n\n Than send `/admincache@TheSheLabot` in that chat to refresh admin list in My database.\n"
        ...
        query.message.edit_text(
            ...
            f"\nCongragulations, @TheSheLabot now ready to manage your group."
            f"\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="* @TheSheLabot support chats*"
            "\nJoin Support Group/Channel",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Supporr", url="https://t.me/cgssupport"),
        ...
        query.message.edit_text(
            text=f"* CREDITS  FOR @TheSheLabot  DEV *\n"
            f"\n Here you can find information about the bots I coded and the people who helped me create SheLa"
