        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "hey shela owner are joined. This Group members lucky 💡 ✪͜͜͜͜͜͜͡͡͡͡͡͡͡͞͞͞͞͞♕͜͜͜͜͜͜͜͜͡͡͡͡͡͡͡✪",
                    reply_to_message_id=reply,
                )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A member of the CGS Union just joined! ❂͜͜͜͡͡͡͡͡☙͜͜͜͜͡͡❂",
                    reply_to_message_id=reply,
                )
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_text(
                    "See you later at the CGS Union!",
                    reply_to_message_id=reply,
                )
                return
...
WELC_PREF_HANDLER = CommandHandler("wekdkdkkdkdk", welcome, filters=Filters.group)
GOODBYE_PREF_HANDLER = CommandHandler("goodbye", goodbye, filters=Filters.group)
SET_WELCOME = CommandHandler("sdnndndndndnnsje", set_welcome, filters=Filters.group)
SET_GOODBYE = CommandHandler("setgoodbye", set_goodbye, filters=Filters.group)
RESET_WELCOME = CommandHandler("resjdjdjkdkdkcome", reset_welcome, filters=Filters.group)
